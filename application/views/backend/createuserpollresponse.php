...
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createuserpollresponsesubmit");?>' enctype= 'multipart/form-data'>
<div class="panel-body">
<div class=" form-group">
<label class="col-sm-2 control-label" for="normal-field">User Poll Option</label>
<div class="col-sm-4">
<?php echo form_dropdown("userpolloption",$userpolloption,set_value('userpolloption'),"class='chzn-select form-control'");?>
</div>
</div>
<div class=" form-group">
