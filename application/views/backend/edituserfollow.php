...
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/edituserfollowsubmit");?>' enctype= 'multipart/form-data'>
...
<div class="col-sm-4">
<?php echo form_dropdown("userfollowed",$userfollowed,set_value('userfollowed',$before->userfollowed),"class='chzn-select form-control'");?>
</div>
</div>
<div class="form-group">
