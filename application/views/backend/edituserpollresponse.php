<section class="panel">
	...
	<div class="panel-body">
		<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/edituserpollresponsesubmit");?>' enctype='multipart/form-data'>
			<input type="hidden" id="normal-field" class="form-control" name="id" value="<?php echo set_value('id',$before->id);?>" style="display:none;">
			<div class=" form-group">
				<label class="col-sm-2 control-label" for="normal-field">User Poll Option</label>
				<div class="col-sm-4">
					<?php echo form_dropdown( "userpolloption",$userpolloption,set_value( 'userpolloption',$before->userpolloption),"class='chzn-select form-control'");?>
				</div>
			</div>
			<div class=" form-group">
